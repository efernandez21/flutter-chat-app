  ...
  Widget _myMessage() {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Text(this.texto, style: TextStyle(color: Colors.white), textAlign: TextAlign.justify,),
  ...
  Widget _notMyMessage() {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Text(this.texto, style: TextStyle(color: Colors.black87), textAlign: TextAlign.justify,),
        decoration: BoxDecoration(
